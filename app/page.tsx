...
export default function Home() {
  ...
  return (
    <div className="bg-cover bg-center px-4 sm:px-6 lg:px-8 md:pt-24 flex flex-col items-center pt-8 sm:pt-20">
      <form onSubmit={handleSearch} className="w-full max-w-xs sm:max-w-md lg:max-w-2xl mb-4">
        ...
        {/* Error message */}
        {errorMsg && (
          <div className="mt-2 -mb-2 sm:mb-0 text-center px-3 py-2 rounded-lg mx-2 bg-black/40 backdrop-blur-md shadow text-base text-white border border-white/20">
            <p>{errorMsg}</p>
          </div>
        )}
      </form>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 w-full max-w-xs sm:max-w-md lg:max-w-2xl mb-8 sm:mb-12">
...

      {
        recentModules.length > 0 && (
          <div className="w-full max-w-2xl text-white -mt-5 sm:mt-0">
            <p className="text-base font-semibold mb-2 sm:mb-4">RECENT</p>
            <div
              className="flex flex-col gap-3 overflow-y-auto max-h-72 pr-2 no-scrollbar"
            >
              {recentModules.length === 0 ? (
