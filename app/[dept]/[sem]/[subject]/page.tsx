                ...
                {modules.length > 0 ? (
                    modules.map((module, index) => (
                        <Link
                            ...
                            className="text-center bg-black/50 hover:bg-black/60 px-6 py-4 rounded-2xl text-lg font-semibold shadow-md transition-all duration-200 backdrop-blur-md border border-gray-700"
                        >
                            Module {module[5]}
                        </Link>
                    ))
