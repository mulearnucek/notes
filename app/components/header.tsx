...
export default function Header() {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    return(
        <div className="w-full h-[10vh] flex justify-around head items-center">
         <h1 className="font-bold text-2xl ml-[1rem]">Your Name</h1>
                    ...
                    <form onSubmit={handleSearch}>
                      ...
                      <input
                       ...
                       <div className="search-box-icon">
                           <button className="btn-icon-content" type="submit" >
